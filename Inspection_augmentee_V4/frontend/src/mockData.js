...
export const AUDITS_TIMELINE = [
  {
    ...
    titreEN: "Document review brief — today's audit",
  ...
  },
  {
    ...
    titreEN: "Preventive maintenance audit — MI2N trains",
  ...
  },
  {
    ...
    titreEN: "Calibration & NC management audit — RER A",
  ...
  {
    id: "pause-dejeuner",
    heure: "12h30", heureMin: 750,
    dureeMin: 60, type: "Pause",
    titre: "Déjeuner", titreEN: "Lunch break", site: null, site_id: null,
    scope: null, referentiel: null, effectif: null,
    responsable: null, nc_ouvertes: null,
    statut: "PLANIFIÉ", action: "12h30",
    trajet: { voiture: "—", velo: "—", pied: "—" }, trajetTC: "—",
    coords: null,
  },
  {
    ...
    titreEN: "Metrology audit — measuring equipment",
  ...
  },
  {
    ...
    titreEN: "Non-conformity control audit",
  ...
  },
  {
    ...
    titreEN: "Quality performance review §9.1",
  ...
  },
  {
    ...
    titreEN: "Video call — Q1 corrective action plan follow-up",
  ...
  },
  {
    ...
    titreEN: "Operator competence & certification audit",
  ...
  },
  {
    ...
    titreEN: "External supplier qualification audit",
  ...
  },
  {
    ...
    titreEN: "Audit closure — Review with Quality Director",
...
export const AUDIT_COURANT = {
  ...
  emplacement: "Atelier Sucy-en-Brie — Bâtiment C, Quai 4",
...
export const CHECKLIST = [
  {
    ...
    titreEN: "Document Control",
    clause: "§7.5",
    points: 4,
    items: [
      { id: "S1-1", texte: "Procédures d'étalonnage à jour", texteEN: "Calibration procedures up to date", statut: "a-venir" },
      { id: "S1-2", texte: "Registres de calibration accessibles", texteEN: "Calibration records accessible", statut: "a-venir" },
      { id: "S1-3", texte: "Instructions de travail signées", texteEN: "Work instructions signed off", statut: "a-venir" },
      { id: "S1-4", texte: "Plan qualité révisé < 12 mois", texteEN: "Quality plan revised < 12 months", statut: "a-venir" },
    ],
  },
  {
    id: "S2",
    titre: "Étalonnage & équipements de mesure",
    titreEN: "Calibration & Measuring Equipment",
    clause: "§7.1.5",
    points: 3,
    items: [
      { id: "S2-1", texte: "Clés dynamométriques étalonnées", texteEN: "Torque wrenches calibrated", statut: "a-venir" },
      { id: "S2-2", texte: "Étiquettes d'étalonnage visibles", texteEN: "Calibration labels visible", statut: "a-venir" },
      { id: "S2-3", texte: "Registre des équipements complet", texteEN: "Equipment register complete", statut: "a-venir" },
    ],
  },
  {
    id: "S3",
    titre: "Gestion des non-conformités",
    titreEN: "Nonconformity Management",
    clause: "§8.7",
    points: 3,
    items: [
      { id: "S3-1", texte: "Zone quarantaine délimitée", texteEN: "Quarantine zone clearly marked", statut: "a-venir" },
      { id: "S3-2", texte: "Étiquetage pièces NC conforme", texteEN: "NC parts labelling compliant", statut: "a-venir" },
      { id: "S3-3", texte: "Traçabilité des actions correctives", texteEN: "Corrective actions traceable", statut: "a-venir" },
    ],
  },
  {
    id: "S4",
    titre: "Compétences & formation",
    titreEN: "Competence & Training",
    clause: "§7.2",
    points: 2,
    items: [
      { id: "S4-1", texte: "Habilitations opérateurs à jour", texteEN: "Operator certifications up to date", statut: "a-venir" },
      { id: "S4-2", texte: "Plan de formation documenté", texteEN: "Training plan documented", statut: "a-venir" },
    ],
  },
  {
    id: "S5",
    titre: "Maîtrise de la production",
    titreEN: "Production Control",
    clause: "§8.5.1",
    points: 3,
    items: [
      { id: "S5-1", texte: "Conditions de production définies et maîtrisées", texteEN: "Production conditions defined and controlled", statut: "a-venir" },
      { id: "S5-2", texte: "Équipements de production conformes aux spécifications", texteEN: "Production equipment meets specifications", statut: "a-venir" },
      { id: "S5-3", texte: "Surveillance des paramètres process en place", texteEN: "Process parameter monitoring in place", statut: "a-venir" },
    ],
  },
  {
    id: "S6",
    titre: "Planification & maîtrise opérationnelle",
    titreEN: "Operational Planning & Control",
    clause: "§8.1",
    points: 3,
    items: [
      { id: "S6-1", texte: "Processus opérationnels planifiés et documentés", texteEN: "Operational processes planned and documented", statut: "a-venir" },
      { id: "S6-2", texte: "Critères d'acceptation des produits définis", texteEN: "Product acceptance criteria defined", statut: "a-venir" },
      { id: "S6-3", texte: "Enregistrements de maîtrise disponibles", texteEN: "Control records available", statut: "a-venir" },
    ],
  },
]
...
export const AUDITS_PRECEDENTS = [
  {
    ...
    alerte: true,
    docs: [
      { id: "doc-1a", nom: "Rapport audit §7.1.5 — nov. 2024", date_depot: "2024-11-18", type: "PDF", url: "/documents/rapport_audit_7.1.5_2024.pdf" },
      { id: "doc-1b", nom: "Plan d'actions correctives étalonnage", date_depot: "2024-11-25", type: "PDF", url: "/documents/pac_etalonnage_2024.pdf" },
    ],
  },
  {
    date: "2024-05-22",
    ...
    alerte: false,
    docs: [
      { id: "doc-2a", nom: "Rapport audit mai 2024", date_depot: "2024-05-28", type: "PDF", url: "/documents/rapport_audit_2024_05.pdf" },
      { id: "doc-2b", nom: "Procédure zone quarantaine rev. 3", date_depot: "2024-06-10", type: "PDF", url: "/documents/proc_quarantaine_rev3.pdf" },
    ],
  },
  {
    date: "2023-10-10",
    ...
    alerte: false,
    docs: [
      { id: "doc-3a", nom: "Rapport audit oct. 2023", date_depot: "2023-10-16", type: "PDF", url: "/documents/rapport_audit_2023_10.pdf" },
    ],
  },
]
...
export const SCOPE_OPTIONS = [
  { id: "so-1", label: "Étalonnage & équipements de mesure",           labelEN: "Calibration & measuring equipment",     sections: ["S2"] },
  { id: "so-2", label: "Gestion des non-conformités",                  labelEN: "Non-conformity management",             sections: ["S3"] },
  { id: "so-3", label: "Maîtrise documentaire",                        labelEN: "Document control",                      sections: ["S1"] },
  { id: "so-4", label: "Compétences & formation",                      labelEN: "Competence & training",                 sections: ["S4"] },
  { id: "so-5", label: "Maîtrise de la production",                    labelEN: "Production control",                    sections: ["S5"] },
  { id: "so-6", label: "Planification & maîtrise opérationnelle",      labelEN: "Planning & operational control",        sections: ["S6"] },
]

export const SUPPLIER_ALERTS = {
  "§7.1.5": { criticite: "majeure", message: "3 clés dyno périmées — NC non clôturée nov. 2024", messageEN: "3 overdue torque wrenches — NC open since Nov. 2024" },
  "§8.7":   { criticite: "mineure", message: "Zone quarantaine partiellement délimitée",           messageEN: "Quarantine zone partially delimited" },
}
