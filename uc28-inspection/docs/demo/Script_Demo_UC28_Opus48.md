...
[DIRE]
  "Deux types identités dans l'application.
...
[DIRE]
  "Aujourd'hui, Marc intervient pour la RATP. 10 missions affectées."
...
[DIRE]
  "Prochain rendez-vous : atelier de Sucy-en-Brie.
   Maintenance des rames MI09 du RER A."
...
[DIRE]
  "Son point apparaît avec le badge « Auditeur ».
   ...
   et devient réutilisable. Deuxième douleur : la préparation se standardise,
...
[CLIC → item §7.1.5 « Etiquettes d'étaloonage visibles »]

[PAUSE — laisser charger suggestions + questions]

[DIRE]
  "Un seul clic, et trois choses arrivent en même temps :
   trois questions de vérification oui/non,
   les articles de la norme se mettent à jour.
...
[DIRE]
  "Marc qualifie en deux gestes.
   Ces réponses partent avec le constat"
